...
public class UserService {
    ...
    public void validateRegistration(User user, String email, String password, String passwordConfirmation) throws ValidationException {
        ...
        if (!email.matches("[^@]*@[^@]*")) {
            throw new ValidationException("Email should contains exactly one letter '@'");
        }
    ...
    public void updateUserAdminRoot(User user, boolean admin) {
        userRepository.updateUserAdminRoot(user.getId(), admin);
    }
}
